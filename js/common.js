...
$(function () {
    ...
    setNav(); var body_width = $('.wrap').eq(1).width(); var resizeTimer = null; 
    ...
    $('#foothelp a').each(function (i) { $(this).click(function () { help_type = i; var b = i + 1; temp_HelpText_index = i; $('.foothelp' + b).eq(0).show(0).siblings('.foothelp').hide(); }) })
...
var js_check_width_list = 0; var newsIndexPage = false; var menu_ul = false; var CaseDetail = false; var CaseDetailSet = 0; 
